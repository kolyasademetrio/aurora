...
function custom_scripts()
{
    ...
    wp_register_script('vide-js', get_template_directory_uri() . '/plugins/vide/jquery.vide.min.js', array('jquery'), NULL, true);
...
add_action('init', function () {
	if ( function_exists('pll_register_string') ) {
		...
		pll_register_string('twentyfifteen', 'Быстрый просчет');
		pll_register_string('twentyfifteen', 'Перезвонить мне');
	}
});
